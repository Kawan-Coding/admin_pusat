                        ...
                        <div class="box-body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="number" min="0" name="harga" value="" class="form-control" id="harga" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="harga_beli" class="control-label">Harga Produksi</label>
                                    <div class="form-group">
                                        <input type="number" min="0" name="harga_beli" value="" class="form-control" id="harga_beli"
                                               required/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="number" min="0" name="kimochi_wallet" value="" class="form-control" id="kimochi_wallet"
                                               required/>
                                    </div>
                                </div>
                                <div class="col-md-12">
