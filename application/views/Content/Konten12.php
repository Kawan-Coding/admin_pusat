                            ...
                            <div class="row clearfix">
                                ...
                                <div class="row col-md-12" style="margin-top:2em">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="tmp_potongan" value="" class="form-control" id="tmp_potongan" min="0" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="number" name="kuota" value="" class="form-control" id="kuota"  min="0" required />
                                        </div>
                                    </div>
                                </div>
